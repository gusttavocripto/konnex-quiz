    ...
    <div style={{ minHeight:"100vh", background:"#050a14", color:"#e2e8f0", fontFamily:"'Inter',sans-serif", position:"relative", overflow:"hidden" }}>
      <style>{`
        ...
        * { box-sizing:border-box; margin:0; padding:0; }
        ...
        input{background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.12);border-radius:12px;color:#e2e8f0;padding:14px 18px;font-size:16px;font-family:'Inter',sans-serif;width:100%;outline:none;transition:border 0.2s}
        input:focus{border-color:rgba(0,229,255,0.5);box-shadow:0 0 0 3px rgba(0,229,255,0.1)}
        ...
        {screen === "result" && (
          <div style={{ width:"100%", textAlign:"center" }}>
            ...
            <div style={{ display:"flex", gap:12, justifyContent:"center", flexWrap:"wrap" }}>
              <button className="btn btn-primary" onClick={()=>{ loadBoard(); setScreen("board"); }}>🏆 View Leaderboard</button>
